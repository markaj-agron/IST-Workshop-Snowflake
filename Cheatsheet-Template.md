...
_In what real-world scenario(s) SSC would be particular useful for a Swiss SME? What problem does it solve or what does it make possible that was impossible before?_

_What does SSC do? How does it interact with the outside world? What are the inputs and the outputs?_

## Benefits and limitations

_What are the most important benefits of using SSC, compared to other solutions?_
